...
{
    name:     'Fiona Green',
    position: 'Chief Operatig Officer (COO)',
    office:   'San Francisco',
    age:      48,
...
},
{
    ...
    position: 'Junior JavascriptDeveloper',
    office:   'Edinburgh',
    age:      43,
